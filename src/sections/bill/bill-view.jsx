...
import TableRow from './bill-table-row';
...
export default function BillPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:8080/api/v1/billing');
  ...
  <div className="modal-content">
   ...
   {!loading && !error && (
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        ...
        <Button variant="contained" color="inherit"  onClick={() => navigate('/createBill')}  startIcon={<Iconify icon="eva:plus-fill" />}>
          New Bill
        </Button>
      </Stack>
            ...
            <Table sx={{ minWidth: 800 }}>
              <TableHead
                ...
                headLabel={[
                  ...
                  { id: 'serviceOffered', label: 'Services Offered' },
